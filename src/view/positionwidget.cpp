...
PositionWidget::PositionWidget(QFile& uiDesc, const AxisMask& am, QWidget* parent)
...
void PositionWidget::setRelative() {
  if (absolute) {
     absolute = false;
     updatePos();
     }
...
void PositionWidget::setAbsolute() {
  if (!absolute) {
     absolute = true;
     updatePos();
     }
...
void PositionWidget::setAbsStyles(QString styles) {
...
void PositionWidget::setRelStyles(QString styles) {
...
void PositionWidget::setLblStyles(QString styles) {
...
void PositionWidget::setDtgStyles(QString styles) {
...
void PositionWidget::setFontSize(int size) {
...
void PositionWidget::resizeEvent(QResizeEvent* e) {
  int h = e->size().height();
...
void PositionWidget::setXHomed(bool homed) {
  ledX->setStyleSheet(homed ? ledOn : ledOff);
  }


void PositionWidget::setYHomed(bool homed) {
  ledY->setStyleSheet(homed ? ledOn : ledOff);
  }


void PositionWidget::setZHomed(bool homed) {
  ledZ->setStyleSheet(homed ? ledOn : ledOff);
  }


void PositionWidget::setAHomed(bool homed) {
  ledA->setStyleSheet(homed ? ledOn : ledOff);
  }


void PositionWidget::setBHomed(bool homed) {
  ledB->setStyleSheet(homed ? ledOn : ledOff);
  }


void PositionWidget::setCHomed(bool homed) {
  ledC->setStyleSheet(homed ? ledOn : ledOff);
  }


void PositionWidget::setUHomed(bool homed) {
  ledU->setStyleSheet(homed ? ledOn : ledOff);
  }


void PositionWidget::setVHomed(bool homed) {
  ledV->setStyleSheet(homed ? ledOn : ledOff);
  }


void PositionWidget::setWHomed(bool homed) {
